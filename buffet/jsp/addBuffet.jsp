...
<html>
  <head>
	...
	<script type="text/javascript" src="Module/buffet/js/addBuffet.js"></script>
	...
	<script type="text/javascript">
		...
		$(function(){
			getBuffetType("类型","selectBuffetTypeDiv","add");
		...
		//在buffet表中获取该章节下该类型的最后一个buffet的num值
		...
		function getBasicBuffetType(buffetTypeId,buffetTypeName){
			if(buffetTypeId == 0){
				...
				var currentBuffetCount = getSubjectList(buffetTypeId) + 1;
  ...
  <body>
  	<div class="addPracticeWrap">
  		<div class="comParentWrap">
		  	<h2 class="headTitle">知识点:${requestScope.loreName}</h2>
		  	<div id="questionDiv">
		   	...
		   	<div id="answerDiv">
			  	...
			  	<div id="editorAns" class="contents" style="display:none;">答案</div>
			   	...
			   	<div id="multi_answer_tk" style="display:none;">
			   		...
			   		<input class="clearBtn" type="button" value="清除已选答案" onclick="clearAllAnswer()"/>
			   	</div>	
			   	<!-- 判断题 -->
	   	...
	   	<html:form action="buffetManager.do">
	   		<input type="hidden" id="action" name="action" value="addBuffet" />
