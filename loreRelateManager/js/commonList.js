...
function showSubjectList(list){
	var t='<span>选择科目</span><select id="subjectId" class="widthSele" onchange="getGradeList(this);">';
...
function showGradeList(list){
	var t='<span>选择年级</span><select id="gradeId" class="widthSele" onchange="getEducationList();">';
...
function showEducationList(list){
	...
	if(loreName != null){
		var t='<span>选择教材</span><select id="educationId" class="widthSele">';
	}else{
		var t='<span>选择教材</span><select id="educationId" class="widthSele" onchange="getChapterList();">';
	}
