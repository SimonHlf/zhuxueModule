...
<html>
  <head>    
	...
	function goStepStudy(loreTypeName){
		if(checkLoginStatus()){
			var param = "&currentLoreId="+currentLoreId+"&loreTypeName="+loreTypeName+"&loreId="+loreId+"&studyLogId="+studyLogId+"&nextLoreIdArray="+currentLoreId+"&subjectId="+subId+"&loreTaskName="+loreTaskName+"&loreName="+loreName+"&educationId="+educationId;
			window.location.href = "studyApp.do?action=goStepStudyPage"+param+"&cilentInfo=app";
		}
	}
	function initBotHei(){
