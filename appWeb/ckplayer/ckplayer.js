...
function showH5Video(videoPath,divCon,width,height){
	var flashvars={
		p:0,
		i:'Module/appWeb/ckplayer/images/startVideo.jpg'
	};
	var video=['/'+videoPath+'->video/mp4'];
	var support=['all'];
	CKobject.embedHTML5(divCon,'ckplayer_a1',width,height,video,flashvars,support);
}