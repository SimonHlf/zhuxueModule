...
iScroll.prototype = {
	...
	*/
	...
	refresh: function () {
		...
		//that.wrapperW = that.options.getScrollW ? that.options.getScrollW : that.wrapper.clientWidth;
		that.wrapperH = that.wrapper.clientHeight || 1;

		that.minScrollY = -that.options.topOffset || 0;
		that.scrollerW = m.round(that.scroller.offsetWidth * that.scale);
		//that.scrollerW = m.round((that.options.getScrollW ? that.scroller.offsetWidth - that.wrapper.offsetWidth + that.options.getScrollW : that.scroller.offsetWidth) * that.scale);
